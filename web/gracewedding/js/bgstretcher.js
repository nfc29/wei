	...
	$.fn.bgStretcher = function(settings){
		...
		function _resize(body_content){
			...
			if(!settings.resizeAnimate){
				...
				container.children('UL').children('LI.img-loaded').find('IMG').stop().animate({'marginLeft': img_options["mar_left"]+'px', 'marginTop': img_options["mar_top"]+'px'}, 'normal');
				container.children('UL').children('LI.img-loaded').find('IMG').stop().animate({'width': img_options["imgW"]+'px', 'height': img_options["imgH"]+'px'}, 'normal');
			}
