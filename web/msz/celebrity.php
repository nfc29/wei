...
<script type="text/javascript" src="js/celebrity.js"></script>
...
<body>
    ...
    <ul class="menu2">
        <li><a href="story.php" megais_ga="celebrity_menu_bt1">品牌故事</a></li>
        <li><a href="reported.php" megais_ga="celebrity_menu_bt2">迴響報導</a></li>
        <li class="now"><a href="celebrity.php" megais_ga="celebrity_menu_bt3">名人誌</a></li>
    </ul>
    ...
    <div id="box">
    	<div class="content">
        	<div class="celebrity">
                <h2>漫談明水然 / 名人誌</h2>
                <b>你們的光臨，讓我們倍感榮幸～</b>
                <!--<p>名人牆，完成！持續增加中～我們感謝每一位光臨的朋友</p>-->
                <p>走過2012，嶄新的2013將如燦爛的旭日般昇起；明水然要陪您一起迎向絢麗彩虹般的2013、一起創造未來～親愛的朋友們，新年快樂！</p>
                <a href="https://www.facebook.com/media/set/?set=a.299526020165233.71733.196073080510528&type=3" target="_blank"><img src="images/celebrity2.png" /></a>
				<a href="https://www.facebook.com/media/set/?set=a.299526020165233.71733.196073080510528&type=3" target="_blank"><img src="images/celebrity.png" class="pic" /></a>
            </div>
    ...
    <a href="https://www.facebook.com/sharer.php?u=http://www.msz.com.tw/" target="_blank" class="fb" megais_ga="fb_bt">明水然Facebook粉絲團</a>
	<div id="wrap"></div>
