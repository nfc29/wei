...
<?include("topMenu.php");?>
    ...
    <ul class="menu2">
        <li><a href="menu.php" megais_ga="customization_menu_bt1">明、水、然饡</a></li>
        <li><a href="lunch.php" megais_ga="customization_menu_bt2">商務精選</a></li>
        <li class="now"><a href="customization.php" megais_ga="customization_menu_bt3">客製品味</a></li>
    </ul>
    ...
    <div id="box">
    	<div class="content">
        	<div class="customization">
                <h2>客製品味</h2>
                <b>明水然，期待為您服務～</b>
                <p>有嚐過用鐵板燒的方式製作出來的蛋糕嗎？這是我們特別為壽星客人準備的小驚喜，師傅花了半個小時做出這酸酸甜甜的絕妙好滋味！</p>
                <p>看到客人驚喜與滿足的表情，我們都相當開心啊～這就是明水然的創意與用心！</p>
				<p>對於您的要求，我們總是盡力去達成，為的就是讓您有賓至如歸的感受～生日快到了嗎，快來明水然享受貴賓般的驚喜！</p>
