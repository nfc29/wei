...
<?include("topMenu.php");?>
    ...
    <ul class="menu2">
        <li class="now"><a href="menu.php" megais_ga="menu_menu_bt1">明、水、然饡</a></li>
        <li><a href="lunch.php" megais_ga="menu_menu_bt2">商務精選</a></li>
        <li><a href="customization.php" megais_ga="menu_menu_bt3">客製品味</a></li>
    </ul>
    ...
    <div id="box">
    	<div class="content">
        	...
        	<a href="#" class="next"></a>
        	<ul class="menu">
            	<li><img src="images/menu1.png" /></li>
                <li><img src="images/menu2.png" /></li>
                <li><img src="images/menu3.png" /></li>
            <!--
                <h2>品味 / 然餐</h2>
                <em>NT<span>1,880</span>/set</em>
                <b>- 日式風味組合 -</b>
                <p>和風明蝦沙拉</p>
                <p>星鰻握壽司</p>
                <p>炙燒比目魚鰭邊肉握壽司</p>
    ...
    <a href="https://www.facebook.com/sharer.php?u=http://www.msz.com.tw/" target="_blank" class="fb" megais_ga="fb_bt">分享到Facebook塗鴉牆</a>
	<div id="wrap"></div>
