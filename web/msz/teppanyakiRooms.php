...
<script type="text/javascript" src="js/teppanyakiRooms.js"></script>
...
<body id="teppanyakiRooms">
    ...
    <ul class="menu2">
        <li><a href="milieu.php" megais_ga="teppanyakiRooms_menu_bt1">明水然之美</a></li>
        <li><a href="privateRooms.php" megais_ga="teppanyakiRooms_menu_bt2">鍋物包廂</a></li>
        <li class="now"><a href="teppanyakiRooms.php" megais_ga="teppanyakiRooms_menu_bt3">鐵板燒包廂</a></li>
    </ul>
    ...
    <div id="box">
    	<div class="content">
        	<div class="milieu">
                <h2>感受 / 鐵板燒包廂</h2>
                <p> 明水然特別重金禮聘經驗豐富、手藝超群的鐵板燒師傅坐鎮，看著新鮮食材在鐵板上飛舞著，不僅口中品嚐到了新鮮美味，視覺饗宴也得到了滿足。</p>
                <p>絕對私密的宴客空間，生日宴會、商談、尾牙、敘舊，請與我們聯繫！</p>
                <p>最尊貴的一席 保留給您~<br>（滿2位即可訂位，請於1日前來電）</p>
            </div>
