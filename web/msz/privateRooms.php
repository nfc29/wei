...
<script type="text/javascript" src="js/privateRooms.js"></script>
...
<?include("topMenu.php");?>
    ...
    <ul class="menu2">
        <li><a href="milieu.php" megais_ga="privateRooms_menu_bt1">明水然之美</a></li>
        <li class="now"><a href="privateRooms.php" megais_ga="privateRooms_menu_bt2">鍋物包廂</a></li>
        <li><a href="teppanyakiRooms.php" megais_ga="privateRooms_menu_bt3">鐵板燒包廂</a></li>
    </ul>
    ...
    <div id="box">
    	<div class="content">
        	<div class="milieu">
                <h2>感受 / 鍋物包廂</h2>
                <p>明水然主打鍋物套餐，特色是將鐵板燒元素融入鍋物套餐中，讓您在一份套餐中可以同時享用到鐵板燒與涮涮鍋，不但美味而且不衝突，是一種大膽且創新的組合！</p>
                <p>明水然對食材方面非常講究，海鮮都是從基隆產地直送，店裡也備有水族箱養殖龍蝦、鮑魚、象胈蚌...，新鮮吃得到也看得見！鍋物料都是特選日本進口，一般市面少見，絕對真材實料。</p>
            </div>
