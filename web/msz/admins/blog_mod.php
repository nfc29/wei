...
include_once "scripts/CKEdit/ckeditor/ckeditor.php";
	...
	$result=$login_control->get_blog($data);
		...
		<form method="POST" id="mod" class="form-horizontal" enctype="multipart/form-data">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="span6 typeahead" id="title" name="title" value="<?=$result['b_title']?>">		
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="textarea ckeditor" id="txtdescription"name="txtdescription" cols="79" rows="15" ><?=$result['b_content']?></textarea>
						<?php
						include_once "scripts/CKEdit/ckeditor/ckeditor.php";
				...
				<div class="control-group">
					...
					<div class="controls">
					<input type="text" class="span6 typeahead" id="url" name="url"value="<?=$result['b_url']?>">			
					</div>
				</div>
				<div class="control-group">
					...
					<?if($result['b_img']!=""){?>
					<input type="hidden" id="pic_old" name="pic_old" value="<?=$result['b_img']?>">
	
					<span id="pic_show">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="del_img('actions/blog_act.php','<?=$result['b_img']?>','<?=$result['b_id']?>')" title="刪除展示圖">
					<img src="img/icons/Close-2-icon.png" style="margin:5px;"></a><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../uploads/blog_img/<?=$result['b_img']?>"rel="lightbox" ><img src="../uploads/blog_img/<?=$result['b_img']?>" style="width:60px;"></a><span style="font-weight:bold;">( 原圖 )</span>
				...
				<div class="control-group">
					...
					<td>
									顯示<label class="radio"><input type="radio" name="enable" id="enable" value="0" <?=($result['b_enable']==0)?"checked":""?>>  </label>
									關閉<label class="radio"><input type="radio" name="enable" id="enable" value="1" <?=($result['b_enable']==1)?"checked":""?>>  </label>
					</td>
