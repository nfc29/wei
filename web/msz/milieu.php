...
<script type="text/javascript" src="js/milieu.js"></script>
...
<?include("topMenu.php");?>
    ...
    <ul class="menu2">
        <li class="now"><a href="milieu.php" megais_ga="milieu_menu_bt1">明水然之美</a></li>
        <li><a href="privateRooms.php" megais_ga="milieu_menu_bt2">鍋物包廂</a></li>
        <li><a href="teppanyakiRooms.php" megais_ga="milieu_menu_bt3">鐵板燒包廂</a></li>
    </ul>
    ...
    <div id="box">
    	<div class="content">
        	<div class="milieu">
                <h2>感受 / 明水然之美</h2>
                <p>明水然整體設計概念走的是低調簡約的風格，主色系運用沉穩的咖啡色系搭配木紋材質與石材，以符合明水然的品牌理念：自然、簡約與高雅；提供您一個可以放鬆並兼顧舒適的用餐環境，讓您像在家用餐一樣自然；店內整體只運用花草與少許藝術品點綴，沒有過多的人工裝飾，讓您可以專注在食材的新鮮與享受餐飲的美味。</p>
                <div class="openingHours">
                    <b>營業時間</b>
                    <p><span>午　餐</span>12:00-15:00(last order:14:30)</p>
                    <!--<p><span> 下午茶</span>14:30~17:00 (每週六/日與國定例假日)</p>-->
                    <p><span>晚　餐</span>18:00-22:00(last order: 20:30)</p>
                </div>
            </div>
            <a href="#" id="close">關閉視窗</a>
        </div>
    </div>
