...
<body id="lunch">
    ...
    <ul class="menu2">
        <li><a href="menu.php" megais_ga="lunch_menu_bt1">明、水、然饡</a></li>
        <li class="now"><a href="lunch.php" megais_ga="lunch_menu_bt2">商務精選</a></li>
        <li><a href="customization.php" megais_ga="lunch_menu_bt3">客製品味</a></li>
    </ul>
    ...
    <div id="box">
    	<div class="content">
        	...
        	<a href="#" class="next"></a>
        	<ul class="menu">
            	<li><img src="images/menu4.png" /></li>
                <li><img src="images/menu5.png" /></li>
                <li><img src="images/menu4.png" /></li>
                <li><img src="images/menu5.png" /></li>
            </ul>
