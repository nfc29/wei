...
if(!class_exists('media')){
	if(file_exists('../lib/media_web_class.php'))
	{
		require_once('../lib/media_web_class.php');
		}
	else if(file_exists('lib/media_web_class.php'))
	{
		require_once('lib/media_web_class.php');
		}
}
...
if(!class_exists('blog')){
	if(file_exists('../lib/blog_web_class.php'))
	{
		require_once('../lib/blog_web_class.php');
		}
	else if(file_exists('lib/blog_web_class.php'))
	{
		require_once('lib/blog_web_class.php');
		}
}
if(!class_exists('work')){
	if(file_exists('../lib/work_web_class.php'))
	{
		require_once('../lib/work_web_class.php');
		}
	else if(file_exists('lib/work_web_class.php'))
	{
		require_once('lib/work_web_class.php');
		}
}
/*if(!class_exists('work')){
	...
	{
		require_once('lib/work_web_classs.php');
		}
}*/
/*if(!class_exists('work')){
