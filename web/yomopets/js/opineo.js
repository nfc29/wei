	...
	$.fn.opineo = function( url, options ) {  
		...
		return this.each(function() {
			...
			var settings = {
				...
				page_id	         : 0,   // page id 文章參數 20130108 新增
				
				show_votes_counter	 : false,     // whether to show votes counter or not
				show_votes_percentage: false,     // whether to show votes percentages or not

				show_total_votes_counter : false,        // whether to show total votes counter or not
				show_overall_rating : false,				// whether to show overall rating or not
				...
				unfilled_star_image  : 'images/star_grey.png', // path for the unfilled star image
				filled_star_image    : 'images/star_yellow.png',      // path for the filled star image
				//half_filled_star : 'images/img-full-star-half.png', // path for the half filled star image
				
				star_1_text      : "一顆星",       // first star tool tip
				star_2_text      : "兩顆星", // second star tool tip
				star_3_text      : "三顆星",     // third star tool tip
				star_4_text      : "四顆星",       // fourth star tool tip
				star_5_text      : "五顆星",       // fifth star tool tip
			...
			stars.bind('click.rating', function(){
				...
				$.getJSON(container.url, {
					...
					"page_id": settings.page_id//20130108 新增
				...
				loadBars: function (responseData){
					...
					if(settings.show_total_votes_counter === true){
						...
						if($(settings.response_container).find('span.rating_total_votes').length > 0){
							...
							$(settings.response_container).find('div.all-votes').append('<span style="margin-right:10px" class="rating_total_votes">' +'您選擇了'+ settings.total_votes_label + ': <b>' + overallRatingCounter + '</b></span>');
						}
					}
